                        ...
                        <form method ="POST" action = "#">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo $rows[$ctr]["driverNumber"];?></th>
                                        <td><?php echo $rows[$ctr]["driverLastName"] .", ". $rows[$ctr]["driverFirstName"].", ". $rows[$ctr]["driverMiddleName"];?></td>
                                        <td><?php echo $rows[$ctr]["address"];?></td>
                                        <td><?php echo $rows[$ctr]["contactNumber"];?></td>
                                        <td><button type="button" class='btn btn-primary w-100'>View<i class='icon-eye float-left' ></i></buttton></td>
                                    </tr>
                                    <?php
                                    $ctr++;
                                    }
